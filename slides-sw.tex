...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{augment}\hlstd{(sleep.1)} \hlopt{%>%} \hlkwd{slice}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{8}\hlstd{)}
\end{alltt}
\begin{verbatim}
## # A tibble: 8 x 9
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{visits.5}\hlkwb{=}\hlkwd{lm}\hlstd{(lgtime}\hlopt{~}\hlstd{phyheal}\hlopt{+}\hlstd{menheal}\hlopt{+}\hlstd{stress,}\hlkwc{data}\hlstd{=visits)}
\hlstd{visits.6}\hlkwb{=}\hlkwd{lm}\hlstd{(lgtime}\hlopt{~}\hlstd{stress,}\hlkwc{data}\hlstd{=visits)}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Parsed with column specification:\\\#\# cols(\\\#\#\ \  dose = col\_integer(),\\\#\#\ \  lived = col\_integer(),\\\#\#\ \  died = col\_integer()\\\#\# )}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: 5 parsing failures.\\\#\# row \# A tibble: 5 x 5 col\ \ \ \  row col\ \  expected\ \ actual\ \ file\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ expected\ \  <int> <chr> <chr>\ \ \ \  <chr>\ \  <chr>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \  actual 1\ \ \ \  2 <NA>\ \ 3 columns 4 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} file 2\ \ \ \  3 <NA>\ \ 3 columns 4 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} row 3\ \ \ \  4 <NA>\ \ 3 columns 4 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} col 4\ \ \ \  5 <NA>\ \ 3 columns 4 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} expected 5\ \ \ \  6 <NA>\ \ 3 columns 5 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{}}}\begin{alltt}
\hlstd{rat2}
\end{alltt}
\begin{verbatim}
## # A tibble: 6 x 3
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Parsed with column specification:\\\#\# cols(\\\#\#\ \  death = col\_integer(),\\\#\#\ \  shock = col\_integer(),\\\#\#\ \  malnut = col\_integer(),\\\#\#\ \  alcohol = col\_integer(),\\\#\#\ \  age = col\_integer(),\\\#\#\ \  bowelinf = col\_integer()\\\#\# )}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in rbind(names(probs), probs\_f): number of columns of result is not a multiple of vector length (arg 1)}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: 106 parsing failures.\\\#\# row \# A tibble: 5 x 5 col\ \ \ \  row col\ \  expected\ \ actual\ \ file\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ expected\ \  <int> <chr> <chr>\ \ \ \  <chr>\ \  <chr>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \  actual 1\ \ \ \  1 <NA>\ \ 6 columns 8 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} file 2\ \ \ \  2 <NA>\ \ 6 columns 8 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} row 3\ \ \ \  3 <NA>\ \ 6 columns 8 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} col 4\ \ \ \  4 <NA>\ \ 6 columns 8 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{} expected 5\ \ \ \  5 <NA>\ \ 6 columns 8 colu\textasciitilde{} 'http://www.utsc.utoronto.\textasciitilde{}\\\#\# ... ................. ... ........................................................... ........ ........................................................... ...... ........................................................... .... ........................................................... ... ........................................................... ... ........................................................... ........ ...........................................................\\\#\# See problems(...) for more details.}}\end{kframe}
\end{knitrout}
...
\item These are in the right order. 
  
\item Now we make an ordered factor out
  of \texttt{Severity} with these as its levels:
  
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{miners} \hlkwb{=} \hlstd{miners} \hlopt{%>%}
    \hlkwd{mutate}\hlstd{(}\hlkwc{sev_ord}\hlstd{=}\hlkwd{ordered}\hlstd{(Severity,v))}
\end{alltt}
\end{kframe}
\end{knitrout}
  \end{itemize}
...
\begin{frame}[fragile]{In the opposite order}
  
\texttt{Severe} down to \texttt{None}:  
  
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{miners} \hlopt{%>%} \hlkwd{mutate}\hlstd{(}\hlkwc{sev2}\hlstd{=}\hlkwd{ordered}\hlstd{(Severity,}\hlkwd{c}\hlstd{(v[}\hlnum{3}\hlstd{],v[}\hlnum{2}\hlstd{],v[}\hlnum{1}\hlstd{])))}
\end{alltt}
\begin{verbatim}
## # A tibble: 24 x 6
## # Groups:   Exposure [8]
##    Exposure Severity  Freq proportion sev_ord  sev2    
##       <dbl> <chr>    <int>      <dbl> <ord>    <ord>   
##  1      5.8 None        98     1      None     None    
##  2     15   None        51     0.944  None     None    
##  3     21.5 None        34     0.791  None     None    
##  4     27.5 None        35     0.729  None     None    
##  5     33.5 None        32     0.627  None     None    
##  6     39.5 None        23     0.605  None     None    
##  7     46   None        12     0.429  None     None    
##  8     51.5 None         4     0.364  None     None    
##  9      5.8 Moderate     0     0      Moderate Moderate
## 10     15   Moderate     2     0.0370 Moderate Moderate
## # ... with 14 more rows
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{preds} \hlkwb{=} \hlstd{miners.pred} \hlopt{%>%}
  \hlkwd{gather}\hlstd{(Severity,probability,None}\hlopt{:}\hlstd{Severe)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
## 19  38   0     2  0.23855071
## 8   35   1     1  0.08404134
## 30  38   1     3  0.73214715
## 3   28   0     1  0.79313204
## 25  32   0     3  0.18702408
## 5   32   0     1  0.40487271
## 15  32   0     2  0.40810321
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in open.connection(con, "{}rb"{}): HTTP error 403.}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'autonoise' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'autonoise' not found}}\end{kframe}
\end{knitrout}
  \end{itemize}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in terms.formula(formula, "{}Error"{}, data = data): object 'autonoise' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in TukeyHSD(autonoise.1): object 'autonoise.1' not found}}\begin{alltt}
\hlstd{autonoise.2}\hlopt{$}\hlstd{`size:type`}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'autonoise.2' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(autonoise, aes(x = size, y = noise, colour = type, group = type)): object 'autonoise' not found}}\end{kframe}
\end{knitrout}
  \end{itemize}
...
\hlstd{autonoise} \hlopt{%>%} \hlkwd{group_by}\hlstd{(size)} \hlopt{%>%}
    ...
    \hlkwd{mutate}\hlstd{(}\hlkwc{p_val}\hlstd{=}\hlkwd{map_dbl}\hlstd{(data,aov_pval))}
\end{alltt}
...
\hlstd{simple_effects} \hlkwb{=} \hlstd{autonoise} \hlopt{%>%} \hlkwd{group_by}\hlstd{(size)} \hlopt{%>%}
    \hlkwd{nest}\hlstd{()} \hlopt{%>%}
    \hlkwd{mutate}\hlstd{(}\hlkwc{p_val}\hlstd{=}\hlkwd{map_dbl}\hlstd{(data,aov_pval))} \hlopt{%>%}
    \hlkwd{select}\hlstd{(}\hlopt{-}\hlstd{data)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'autonoise' not found}}\begin{alltt}
\hlstd{simple_effects}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'simple\_effects' not found}}\end{kframe}
\end{knitrout}
  \end{itemize}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'simple\_effects' not found}}\end{kframe}
\end{knitrout}
...
\hlstd{cis} \hlkwb{=} \hlstd{autonoise} \hlopt{%>%}
    ...
    \hlkwd{mutate}\hlstd{(}\hlkwc{ci}\hlstd{=}\hlkwd{map}\hlstd{(data,ci_func))} \hlopt{%>%}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'cis' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'cis' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gather(chain.wide, model, kickback, A:D, factor\_key = T): object 'chain.wide' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'chain' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in contrasts(chain\$model) = m: object 'chain' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.data.frame(data): object 'chain' not found}}\begin{alltt}
\hlkwd{summary}\hlstd{(chain.1)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in summary(chain.1): object 'chain.1' not found}}\end{kframe}
\end{knitrout}
}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in tidy(chain.1): object 'chain.1' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(lhs, parent, parent): object 'prepost' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in update(prepost.1, . \textasciitilde{} . - before:drug): object 'prepost.1' not found}}\begin{alltt}
\hlkwd{anova}\hlstd{(prepost.2)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in anova(prepost.2): object 'prepost.2' not found}}\end{kframe}
\end{knitrout}
}
