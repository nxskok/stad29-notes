...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-422-1.pdf}
\caption{plot of chunk unnamed-chunk-422}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-425-1.pdf}
\caption{plot of chunk unnamed-chunk-425}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-432-1.pdf}
\caption{plot of chunk unnamed-chunk-432}
\end{figure}
...
\begin{Highlighting}[]
\NormalTok{square }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pivot_longer}\NormalTok{(}\OperatorTok{-}\NormalTok{x, }\DataTypeTok{names_to=}\StringTok{"point"}\NormalTok{, }\DataTypeTok{values_to=}\StringTok{"distance"}\NormalTok{) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{pivot_wider}\NormalTok{(}\DataTypeTok{names_from=}\NormalTok{point, }\DataTypeTok{values_from=}\NormalTok{distance) ->}\StringTok{ }\NormalTok{noc}
\NormalTok{noc}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pivot_wider}\NormalTok{(}\DataTypeTok{names_from=}\NormalTok{place, }\DataTypeTok{values_from=}\NormalTok{distance) }\OperatorTok{%>%}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-486-1.pdf}
\caption{plot of chunk unnamed-chunk-486}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-492-1.pdf}
\caption{plot of chunk unnamed-chunk-492}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-500-1.pdf}
\caption{plot of chunk unnamed-chunk-500}
\end{figure}
...
\includegraphics{figure/unnamed-chunk-607-1.pdf}
...
\includegraphics{figure/unnamed-chunk-614-1.pdf}
...
\includegraphics{figure/unnamed-chunk-618-1.pdf}
...
\includegraphics{figure/unnamed-chunk-621-1.pdf}
...
\includegraphics{figure/unnamed-chunk-624-1.pdf}
...
\includegraphics{figure/unnamed-chunk-627-1.pdf}
...
\includegraphics{figure/unnamed-chunk-629-1.pdf}
