...
\begin{frame}[fragile]{The output xxx}
\protect\hypertarget{the-output-xxx}{}
...
\begin{frame}[fragile]{Residual plot xxx}
\protect\hypertarget{residual-plot-xxx}{}
...
\begin{frame}[fragile]{Regression 2 xxx}
\protect\hypertarget{regression-2-xxx}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glimpse}\NormalTok{(curvy}\FloatTok{.2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{The residual plot now xxx}
\protect\hypertarget{the-residual-plot-now-xxx}{}
...
\begin{frame}[fragile]{Scatterplot: faster than linear growth xxx}
\protect\hypertarget{scatterplot-faster-than-linear-growth-xxx}{}
...
\begin{frame}[fragile]{The data xxx}
\protect\hypertarget{the-data-xxx}{}
...
\begin{frame}[fragile]{Just \texttt{menheal} xxx}
\protect\hypertarget{just-menheal-xxx}{}
...
\begin{frame}[fragile]{Residual plot (from \texttt{timedrs} on all) xxx}
\protect\hypertarget{residual-plot-from-timedrs-on-all-xxx}{}
...
\begin{frame}{Comment xxx}
\protect\hypertarget{comment-xxx}{}
...
\emph{absolute value} of residual against fitted value: xxx
...
\item
  ...
  value.
\item
  Sometimes residuals are \emph{very} positive: observed a \emph{lot}
  larger than predicted.
\item
  Try \emph{transforming} response: use log or square root of response.
  (Note that response is \emph{count}, often skewed to right.)
\item
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-84-1.pdf}
\caption{plot of chunk unnamed-chunk-84}
\end{figure}
...
\includegraphics{figure/unnamed-chunk-100-1.pdf} mlogit.pdf
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-122-1.pdf}
\caption{plot of chunk unnamed-chunk-122}
\end{figure}
...
\includegraphics{figure/unnamed-chunk-151-1.pdf} def
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-167-1.pdf}
\caption{plot of chunk unnamed-chunk-167}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-171-1.pdf}
\caption{plot of chunk unnamed-chunk-171}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-215-1.pdf}
\caption{plot of chunk unnamed-chunk-215}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-233-1.pdf}
\caption{plot of chunk unnamed-chunk-233}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-249-1.pdf}
\caption{plot of chunk unnamed-chunk-249}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-260-1.pdf}
\caption{plot of chunk unnamed-chunk-260}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-290-1.pdf}
\caption{plot of chunk unnamed-chunk-290}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-314-1.pdf}
\caption{plot of chunk unnamed-chunk-314}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-329-1.pdf}
\caption{plot of chunk unnamed-chunk-329}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-332-1.pdf}
\caption{plot of chunk unnamed-chunk-332}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-446-1.pdf}
\caption{plot of chunk unnamed-chunk-446}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-447-1.pdf}
\caption{plot of chunk unnamed-chunk-447}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-468-1.pdf}
\caption{plot of chunk unnamed-chunk-468}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-481-1.pdf}
\caption{plot of chunk unnamed-chunk-481}
\end{figure}
...
\NormalTok{  row }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{366}\NormalTok{, }\DecValTok{311}\NormalTok{, }\DecValTok{214}\NormalTok{),}
...
\begin{Highlighting}[]
\NormalTok{bem_tidy }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(row }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{359}\NormalTok{, }\DecValTok{258}\NormalTok{, }\DecValTok{230}\NormalTok{), }\KeywordTok{abs}\NormalTok{(Factor1) }\OperatorTok{>}\StringTok{ }\FloatTok{0.4}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{subno, }\OperatorTok{-}\NormalTok{Factor1, }\OperatorTok{-}\NormalTok{Factor2) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(row, score)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-538-1.pdf}
\caption{plot of chunk unnamed-chunk-538}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-547}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{temp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{time_period=}\KeywordTok{ifelse}\NormalTok{(year}\OperatorTok{<=}\DecValTok{1970}\NormalTok{, }\StringTok{"pre-1970"}\NormalTok{, }\StringTok{"post-1970"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{nest}\NormalTok{(}\OperatorTok{-}\NormalTok{time_period) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{theil_sen=}\KeywordTok{map_dbl}\NormalTok{(data, }\OperatorTok{~}\KeywordTok{theil_sen_slope}\NormalTok{(.}\OperatorTok{$}\NormalTok{temperature)))}
\end{Highlighting}
\end{Shaded}
...
\caption{plot of chunk unnamed-chunk-554}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-555}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-559-1.pdf}
\caption{plot of chunk unnamed-chunk-559}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-561-1.pdf}
\caption{plot of chunk unnamed-chunk-561}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-563}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-564}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-565}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-569}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-574}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-576-1.pdf}
\caption{plot of chunk unnamed-chunk-576}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-577}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-578}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-584-1.pdf}
\caption{plot of chunk unnamed-chunk-584}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-587}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-588-1.pdf}
\caption{plot of chunk unnamed-chunk-588}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-599-1.pdf}
\caption{plot of chunk unnamed-chunk-599}
\end{figure}
