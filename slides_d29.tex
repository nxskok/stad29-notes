...
\item
  Course website: xxx \href{http://ritsokiguess.site/STAD29/}{link}.
\item
...
\begin{frame}{Course material xxx}
\protect\hypertarget{course-material-xxx}{}
...
\begin{frame}[fragile]{Check data xxx}
\protect\hypertarget{check-data-xxx}{}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{glimpse}\NormalTok{(sleep)}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}{Exploratory stuff}
\protect\hypertarget{exploratory-stuff}{}
...
\begin{itemize}
\item
  \texttt{xx}-squared term initely significant (P-value 0.000182), so
...
\caption{plot of chunk unnamed-chunk-21}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-24-1.pdf}
\caption{plot of chunk unnamed-chunk-24}
\end{figure}
...
\item
  ...
  value.
\item
  Sometimes residuals are *very\} positive: observed a
  \{\em lot* larger than predicted.
\item
  Try * transforming\} response: use log or square root of response.
  (Note that response is \{\em count*, often skewed to right.)
\item
...
\caption{plot of chunk unnamed-chunk-536}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-545-1.pdf}
\caption{plot of chunk unnamed-chunk-545}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-552}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-553}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-562}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-582}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-585}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-586}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-589-1.pdf}
\caption{plot of chunk unnamed-chunk-589}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-592}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-595-1.pdf}
\caption{plot of chunk unnamed-chunk-595}
\end{figure}
