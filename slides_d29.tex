...
\begin{frame}[fragile]{Cluster Analysis xxx from here}
\protect\hypertarget{cluster-analysis-xxx-from-here}{}
...
\item
  Without knowledge of groups, use \emph{cluster analysis} xxx: see
  which individuals close, which groups suggested by data.
\item
...
Dissimilarities for language data xxx were how many number names had
...
\begin{frame}[fragile]{Clustering process xxx}
\protect\hypertarget{clustering-process-xxx}{}
...
\item
  First get the lines for English: \footnotesize
\end{itemize}
