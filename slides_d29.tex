...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{s1 <-}\StringTok{ }\KeywordTok{do.call}\NormalTok{(survfit, }\KeywordTok{list}\NormalTok{(}\DataTypeTok{formula=}\NormalTok{dance}\FloatTok{.1}\NormalTok{, }
                            \DataTypeTok{newdata=}\NormalTok{dance.new, }
                            \DataTypeTok{data=}\NormalTok{dance))}
...
\begin{frame}[fragile]{``Strata'' (groups)}
\protect\hypertarget{strata-groups}{}
...
\NormalTok{s1 <-}\StringTok{ }\KeywordTok{do.call}\NormalTok{(survfit, }\KeywordTok{list}\NormalTok{(}\DataTypeTok{formula =}\NormalTok{ lung}\FloatTok{.3}\NormalTok{, }
                            \DataTypeTok{data =}\NormalTok{ lung.complete, }
                            \DataTypeTok{newdata =}\NormalTok{ lung.new))}
\NormalTok{g <-}\StringTok{ }\KeywordTok{ggsurvplot}\NormalTok{(s1, }\DataTypeTok{conf.int =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-182-1.pdf}
\caption{plot of chunk unnamed-chunk-182}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-187-1.pdf}
\caption{plot of chunk unnamed-chunk-187}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-197-1.pdf}
\caption{plot of chunk unnamed-chunk-197}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-201-1.pdf}
\caption{plot of chunk unnamed-chunk-201}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-211-1.pdf}
\caption{plot of chunk unnamed-chunk-211}
\end{figure}
...
\NormalTok{\}}
\NormalTok{autonoise }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{nest}\NormalTok{(}\OperatorTok{-}\NormalTok{size) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{pivot_longer}\NormalTok{(A}\OperatorTok{:}\NormalTok{D, }\DataTypeTok{names_to =} \StringTok{"model"}\NormalTok{, }\DataTypeTok{names_ptypes =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{model=}\KeywordTok{factor}\NormalTok{()), }
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-318-1.pdf}
\caption{plot of chunk unnamed-chunk-318}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-338-1.pdf}
\caption{plot of chunk unnamed-chunk-338}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-342-1.pdf}
\caption{plot of chunk unnamed-chunk-342}
\end{figure}
...
\caption{plot of chunk unnamed-chunk-348}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-352-1.pdf}
\caption{plot of chunk unnamed-chunk-352}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-358-1.pdf}
\caption{plot of chunk unnamed-chunk-358}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{figure/unnamed-chunk-441-1.pdf}
\caption{plot of chunk unnamed-chunk-441}
\end{figure}
...
\includegraphics{figure/unnamed-chunk-507-1.pdf} \normalsize
...
\includegraphics{figure/unnamed-chunk-514-1.pdf}
...
\includegraphics{figure/unnamed-chunk-525-1.pdf}
...
\includegraphics{figure/unnamed-chunk-531-1.pdf}
...
\includegraphics{figure/unnamed-chunk-533-1.pdf}
...
\includegraphics{figure/unnamed-chunk-537-1.pdf}
...
\includegraphics{figure/unnamed-chunk-544-1.pdf}
...
\includegraphics{figure/unnamed-chunk-548-1.pdf}
