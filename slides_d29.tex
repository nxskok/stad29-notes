...
\begin{frame}[fragile]{Are 2 factors enough? xxx}
\protect\hypertarget{are-2-factors-enough-xxx}{}
...
\begin{frame}[fragile]{xxx Track records by factor analysis}
\protect\hypertarget{xxx-track-records-by-factor-analysis}{}
...
\begin{frame}{xxx The whole inventory}
\protect\hypertarget{xxx-the-whole-inventory}{}

\includegraphics[width=0.05208in,height=\textheight]{bem.png}
...
\begin{frame}[fragile]{xxx The scree plot}
\protect\hypertarget{xxx-the-scree-plot}{}
...
\begin{frame}[fragile]{Zoom in to search for elbow xxx}
\protect\hypertarget{zoom-in-to-search-for-elbow-xxx}{}
...
\begin{frame}[fragile]{xxx Plotting the two factors}
\protect\hypertarget{xxx-plotting-the-two-factors}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bem }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{subno) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{factanal}\NormalTok{(,. }\DataTypeTok{factors=}\DecValTok{2}\NormalTok{, }\DataTypeTok{scores=}\StringTok{"r"}\NormalTok{) ->}\StringTok{ }\NormalTok{bem}\FloatTok{.2}\NormalTok{a}
...
\begin{frame}{Comments xxx}
\protect\hypertarget{comments-xxx-2}{}
...
\begin{frame}[fragile]{xxx Specifying a factor model}
\protect\hypertarget{xxx-specifying-a-factor-model}{}
...
\begin{frame}[fragile]{xxx Track and field data, yet again}
\protect\hypertarget{xxx-track-and-field-data-yet-again}{}
...
\begin{frame}[fragile]{xxx Factor model 2}
\protect\hypertarget{xxx-factor-model-2}{}
