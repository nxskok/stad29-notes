...
\end{small}
* The map: xxx
```{r message=F,fig.height=2,fig.width=2}
mds_map("square.csv")
```
...
## The MDS map and Google map side by side

```{r, echo=F}
ggsave(g2, "g2.pdf", "pdf")
ggsave(gmap, "gmap.pdf", "pdf")
```
...
\includegraphics[width=0.9\textwidth]{gmap}
